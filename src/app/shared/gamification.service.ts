...
export class GamificationService {
  ...
  private gamification: Gamification[] = [
    ...
    // new Gamification (1, true, "[Muito Mal, Mal, Indiferente, Bem, Muito Bem]", 'Amigos', "Como você se sente hoje no relacionamento com seus amigos?"),
    // new Gamification (2, true, "[Muito Mal, Mal, Indiferente, Bem, Muito Bem]", 'Colegas de trabalho', "Como você se sente hoje no relacionamento com seus colegas de trabalho?"),
    // new Gamification (3, true, "[Muito Preconceito, Bastante, Neutro , Pouco, Nenhum Preconceito]", 'Preconceito', "Como você se sente hoje com relação ao preconceito que tem sofrido?"),
    // new Gamification (4, true, "[Muita Fissura, Bastente, Neutro, Pouca, Nenhuma Fissura]", "Vontade de uso", "Como você se sente hoje com relação as “fissuras” ao longo do dia?" ),
    // new Gamification (5, true, "[Muita Mudança, Bastante , Neutro , Pouca, Nenhuma Mudança]", 'Humor', "Como você se sente hoje com relação as possíveis mudanças no seu humor ao longo do dia?"),
